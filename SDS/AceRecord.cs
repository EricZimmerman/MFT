    ...
    public class AceRecord
    {
        ...
        public string Sid
        {
            get
            {
                ...
                return SecurityDescriptor.ConvertHexStringToSidString(rawSid);
            }
        }

        public SecurityDescriptor.SidTypeEnum SidType => SecurityDescriptor.GetSidTypeFromSidString(Sid);
        ...
        public override string ToString()
        {
            ...
            sb.AppendLine($"SID Type Description: {SecurityDescriptor.GetDescriptionFromEnumValue(SidType)}");
