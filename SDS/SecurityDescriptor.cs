...
namespace Secure
{
    ...
    public class SecurityDescriptor
    {
        ...
        /// </summary>
        public SecurityDescriptor(byte[] rawBytes)
        {
            RawBytes = rawBytes;
        ...
        public string GroupSid
        {
            get
            {
                ...
                return ConvertHexStringToSidString(rawGroup);
            }
        }

        public SidTypeEnum GroupSidType => GetSidTypeFromSidString(GroupSid);
        ...
        public string OwnerSid
        {
            get
            {
                ...
                return ConvertHexStringToSidString(rawOwner);
            }
        }

        public SidTypeEnum OwnerSidType => GetSidTypeFromSidString(OwnerSid);
